...
import { BrowserRouter, Routes, Route, useNavigate } from 'react-router-dom';
 ...
 import Main from './logged'
  ...
  const  Registration = () =>{
    ...
    try {
       const response = axios.post('https://backend-3-4sig.onrender.com/user/login', formData1);
    ...
    const [formData, setFormData] = useState({
     ...
     const handleSubmit = async (e) => {
       e.preventDefault();
        ...
        const response = axios.post('https://backend-3-4sig.onrender.com/register', formData);
